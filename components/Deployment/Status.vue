<template>
    <n-tooltip trigger="hover">
        <template #trigger>
            <naive-icon v-if="deployment.status === 'active'" name="ph:caret-circle-double-down-duotone" :size="size"
            ...
            <naive-icon v-if="deployment.status === 'succeded'" name="ph:check-circle-duotone" :size="size"
